...
use Site\NedraBundle\Entity\News;
use Site\NedraBundle\Form\NewsType;
...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SiteNedraBundle:News')->findAll();

        return $this->render('SiteNedraBundle:News:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function indexfrontAction()
    {
        ...
        return $this->render('SiteNedraBundle:Front:showNewsFront.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SiteNedraBundle:News:new.html.twig', array(
            'entity' => $entity,
