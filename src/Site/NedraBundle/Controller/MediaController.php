...
use Site\NedraBundle\Entity\Media;
use Site\NedraBundle\Form\MediaType;
...
class MediaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SiteNedraBundle:Media')->findAll();

        return $this->render('SiteNedraBundle:Media:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function indexFrontAction()
    {
        ...
        return $this->render('SiteNedraBundle:Front:showMediaFront.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SiteNedraBundle:Media:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SiteNedraBundle:Media')->find($id);
        ...
        return $this->render('SiteNedraBundle:Media:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SiteNedraBundle:Media:edit.html.twig', array(
            'entity'      => $entity,
